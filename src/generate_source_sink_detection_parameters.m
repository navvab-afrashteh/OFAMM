...
Nnested_source = 3; % minimum number of nested sources to verify the most interior source
Nnested_sink = 3; % minimum number of nested sources to verify the most interior sink

% write Parameters into .txt file if needed.
fileID = fopen([SSParamsPathName, '\Source-Sink Detection Parameters.txt'],'w');
